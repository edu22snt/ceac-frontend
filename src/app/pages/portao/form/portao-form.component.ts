...
@Component({
  ...
  templateUrl: './portao-form.component.html',
  styleUrl: './portao-form.component.scss'
})
export class PortaoFormComponent implements OnInit {
  ...
  salvar(): void {
    if (this.form.valid) {
      const portao: IPortao = this.form.value;
      this.service.create(portao).subscribe({
        next: () => {
        this.voltar();
  ...
  update(): void {
    if (this.form.valid) {
      const portao: IPortao = this.form.value;
      this.service.update(portao).subscribe({
        next: () => {
        this.voltar();
