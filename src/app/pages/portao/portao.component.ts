...
@Component({
  ...
  templateUrl: './portao.component.html',
  styleUrl: './portao.component.scss'
})
export class PortaoComponent implements OnInit {
  ...
  dataSource = new MatTableDataSource<IPortao>();
  ...
  new(): void {
    this.router.navigate(['/portao-form']);
  }
